...
export function TermsSettings() {
  ...
  if (isError) {
    return <div className="text-red-500 text-center mt-8">Failed to load Terms & Conditions</div>;
  }

  return (
    <div className="bg-white h-full p-4 rounded-2xl">
      <div className="mb-6">
        <h1 className="text-2xl text-primary font-semibold">Terms & Conditions</h1>
        <p className='text-slate-600 pt-3'>Edit your application's Terms & Conditions</p>
      </div>
      <div>
        <JoditEditor
          ref={editor}
